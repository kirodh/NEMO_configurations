...
DIR_ARCHI_INIT=$MAINPATH/NEMOGCM/CONFIG/Reffray_generic_lev51_results/EXP00/input     # PATH for the initial condition file
DIR_ARCHI_FORC=$MAINPATH/NEMOGCM/CONFIG/Reffray_generic_lev51_results/EXP00/input     # PATH for the forcing input files
