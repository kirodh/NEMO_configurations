...
DIR_ARCHI_INIT=$MAINPATH/NEMOGCM/CONFIG/Reffray_kw_lev21_results/EXP00/input     # PATH for the initial condition file
DIR_ARCHI_FORC=$MAINPATH/NEMOGCM/CONFIG/Reffray_kw_lev21_results/EXP00/input     # PATH for the forcing input files
