...
DIR_ARCHI_INIT=$MAINPATH/NEMOGCM/CONFIG/t1/EXP00/input     # PATH for the initial condition file
DIR_ARCHI_FORC=$MAINPATH/NEMOGCM/CONFIG/t1/EXP00/input     # PATH for the forcing input files
