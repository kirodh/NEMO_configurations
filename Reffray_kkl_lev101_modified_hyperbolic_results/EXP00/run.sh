...
DIR_ARCHI_INIT=$MAINPATH/NEMOGCM/CONFIG/Reffray_kkl_lev101_modified_hyperbolic_results/EXP00/input     # PATH for the initial condition file
DIR_ARCHI_FORC=${DIR_ARCHI_INIT}     # PATH for the forcing input files
