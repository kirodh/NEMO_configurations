...
!CDIR NOVERRCHK
                  ...
                  DO jj = 1, jpj
                     DO ji = 1, jpi
                        zc0 = rn_abs * EXP( - e3t_0(ji,jj,1) * xsi0r     )
                        zc1 = zcoef  * EXP( - e3t_0(ji,jj,1) * zekb(ji,jj) )
                        zc2 = zcoef  * EXP( - e3t_0(ji,jj,1) * zekg(ji,jj) )
                        zc3 = zcoef  * EXP( - e3t_0(ji,jj,1) * zekr(ji,jj) )
