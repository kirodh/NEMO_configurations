...
!!$      zlv(:,:,jpk) = 0.e0
      ...
      DO jk = 1, jpkm1
         ...
         zlu(:,:,jk) = zlu(:,:,jk) * ( ahm0_blp * (1-nkahm_smag) + nkahm_smag)

         zlv(:,:,jk) = zlv(:,:,jk) * ( ahm0_blp * (1-nkahm_smag) + nkahm_smag)
      ...
      DO jk = 1, jpkm1      
         ...
         DO jj = 2, jpjm1
            DO ji = 2, jpim1   ! vector opt.
               ...
               ua(ji,jj,jk) = ua(ji,jj,jk) + zua * ( ahm0_blp*nkahm_smag +(1 -nkahm_smag ))
               va(ji,jj,jk) = va(ji,jj,jk) + zva * ( ahm0_blp*nkahm_smag +(1 -nkahm_smag ))
            END DO
         END DO
